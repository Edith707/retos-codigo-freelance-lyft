...
2. Clonar tu fork en una carpeta.

3. Hacer el maquetado en html, utilizando etiquetas de html5.

4. Vincular con un link en head el documento main.css para dar estilo.

5. Elegir la fuente de google fonts y vincularlo con un link en head.

6. Bajar los logos de Icomoon en una carpeta y vincularlo con un documento style css.

7. Dar formato al documento seccion por seccion.

8. Agregar los links de videos a la página.

9. Agregar los vinculos de la página.

10. Agregar los comentarios al html y css.
